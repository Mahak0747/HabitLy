    ...
    <div className="min-h-screen flex items-center justify-center bg-ink-50 dark:bg-ink-950 px-5 py-10">
      ...
      >
        ...
        <div className="bg-white dark:bg-ink-900 rounded-2xl shadow-card border border-ink-900/5 dark:border-white/5 p-7 sm:p-8">
          ...
          <p className="text-sm text-ink-900/55 dark:text-ink-50/55 mb-6">Start your first streak in under a minute.</p>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              <label className="text-xs font-semibold text-ink-900/60 dark:text-ink-50/60 mb-1.5 block">Name</label>
              <input
                required
                value={form.name}
          ...
          <p className="text-sm text-center text-ink-900/55 dark:text-ink-50/55 mt-6">
            Already have an account? <Link to="/login" className="text-brand-600 dark:text-brand-300 font-semibold">Log in</Link>
          </p>
        </div>
      </motion.div>
    </div>
